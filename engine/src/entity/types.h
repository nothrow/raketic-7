...
enum entity_type {
  ...
  ENTITY_TYPE_MOON,
  ENTITY_TYPE_SATELLITE,
  ENTITY_TYPE_PART_RADAR,
  ENTITY_TYPE_SUN,
  ENTITY_TYPE_COUNT,
};
...
static entity_type_t ENTITY_TYPEREF_MOON = { ENTITY_TYPE_MOON };
static entity_type_t ENTITY_TYPEREF_SATELLITE = { ENTITY_TYPE_SATELLITE };
static entity_type_t PART_TYPEREF_RADAR = { ENTITY_TYPE_PART_RADAR };
static entity_type_t ENTITY_TYPEREF_SUN = { ENTITY_TYPE_SUN };

#define WEAPON_TYPE_LASER  0
#define WEAPON_TYPE_ROCKET 1
#define WEAPON_TYPE_TURRET_LASER 2
